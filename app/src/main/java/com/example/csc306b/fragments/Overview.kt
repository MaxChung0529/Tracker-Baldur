...
class Overview() : Fragment() {
    ...
    private fun addData() {
        ...
        for (i in 0 until groupedList.size) {
            ...
            hoursLogged.setText("${round(groupedList[i].second * 100.00) / 100.00} Hour(s)")
        ...
        val minute = totalHour - totalHour.toInt()

        totalHourText.setText("${mainActivity.getText(R.string.totalHoursLogged)} ${round(totalHour * 100.00) / 100.00}")
